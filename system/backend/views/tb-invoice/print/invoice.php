        ...
        <div class="col-md-12">
            <div class="card card-body">
                <div class="row">
                        ...
                        <div class="table-responsive m-t-40" style="clear: both;">
                            <table class="table1">
                                <tr>
                                    ...
                                    <th class="text-center"><h3><strong>INVOICE</strong></h3></th>
                                </tr>
                                <tr>
                    ...
                    <!-- SIGNATURE -->
                    <div>
                    <table style ="align:center; width:100%; padding-top:10px; padding-left: 5px;">
                    <tr>
                        <td style="text-align: left; font-size: 14px; border: none; line-height:15px;"><b>PEMBAYARAN DAPAT DI TRANSFER <br style="line-height:10px;"> REKENING KAMI<br>
