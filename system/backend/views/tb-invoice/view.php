        ...
        <div class="card-text">
            <div class="tb-invoice-view">
                <p>
                    ...
                    <?= Html::a('<i class="fa fa-print"></i> Cetak Invoice', ['print-invoice', 'id' => $model->id], ['class' => 'btn btn-info']) ?>
                    <?= Html::a('<i class="fa fa-wrench"></i> Working Order', ['print-mechanic', 'id' => $model->id], ['class' => 'btn btn-danger']) ?>
