...
<head>
    ...
    <?php $this->head() ?>
    <link rel="shortcut icon" href="<?=Url::base()?>/dist/img/jackeylogo.png">
    <style type="text/css">
        .loadingin {
            top: 0px;
            left: 0px;
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="<?=Url::base()?>/dist/img/jackeylogo2.png"
           alt="Bahdranaya Group"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Jackey Motor</span>
    </a>
  ...
  <footer class="main-footer text-sm">
    ...
    <strong>Copyright &copy; 2010-2021 <a href="https://jackeymotor.com">Jackey Motor</a>.</strong> All rights reserved.
  </footer>
